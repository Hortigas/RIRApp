            ...
            content = { innerPadding ->
                Column(
                    ...
                    RadioButton(
                        ...
                        selectedOption = viewModel.aprovacao1,
                        onChange = { viewModel.onEvent(AddEditRirEvent.OnAprovacao1Change(it)) }
                    )
                    RadioButton(
                        title = "Houve algum tipo de não-conformidade?",
                        optionsList = listOf("SIM", "NÃO"),
                        selectedOption = viewModel.aprovacao2,
                        onChange = { viewModel.onEvent(AddEditRirEvent.OnAprovacao2Change(it)) }
                    )
                    Dropdown(
